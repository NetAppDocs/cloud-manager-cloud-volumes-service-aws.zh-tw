$(document).ready(function () {
  try {
    ...
    let baseUrlSection = "/zh-tw/cloud-manager-cloud-volumes-service-aws/pdfs/";
    ...
    zipFilename = zipFilename !== ''?zipFilename:"cloud-manager-cloud-volumes-service-aws.zh-tw.zip";
